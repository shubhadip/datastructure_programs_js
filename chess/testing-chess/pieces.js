...
// createBoard
 // create div
 // add Classes backgrouncolor
 // different player1 player2 colors elements
 // add draggable to entries with child elements
let width = 8;
...
function createBoard() {
    ...
    BoardMap.forEach((e, i) => {
        const square = document.createElement('div')
        square.innerHTML = e;
        square.classList.add('square');
        const currentRow = Math.floor((63 - i)/ 8) + 1
